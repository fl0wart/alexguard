...
my_token = 'NTU3MjUwNjE4NTY2MjQ2NDAw.D3Fjqw.nI6gQJLzpkm48M3yeUad8eRyV-A'

client = commands.Bot(command_prefix = 'a!')

client.remove_command('help')
status = ['a!help | ALEX-GUARD', 'made by fl0w. 💔#1337', "BOT FACUT CU 5€ !"]
...
async def help(ctx):
    ...
    embed.add_field(name ='a!purge', value ='Deletes certain amount of messages, default amount is 10', inline=False)
    embed.add_field(name ='a!join', value ='The bot joins the current voice channel, the user must be in a voice channel to use this command', inline=False)
    ...
    embed.add_field(name ='a!serverinfo', value ='Gives the server information on the selected user,so you must do ;serverinfo and mention the user!', inline=False)
    embed.add_field(name ='Bot creat de fl0w. 💔#1337 pt Alex cu doar 5€ !!', value ='Server-ul lui fl0w: https://discord.gg/Nr7kxSJ', inline=False)
...
client.run('NTU3MjUwNjE4NTY2MjQ2NDAw.D3Fjqw.nI6gQJLzpkm48M3yeUad8eRyV-A')
